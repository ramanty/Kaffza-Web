  ...
  return (
    <main dir="ltr" className="mx-auto max-w-4xl px-6 py-12">
      <div className="flex items-center justify-between gap-3">
        <h1 className="text-kaffza-primary text-3xl font-extrabold">{feature.titleEn}</h1>
        <Link className="text-kaffza-text/70 text-sm font-bold underline" href="/en/features">
          Back to features
        </Link>
      </div>

      <p className="text-kaffza-text/80 mt-3 text-sm">{feature.summaryEn}</p>

      <Card className="mt-8 p-6">
        <h2 className="text-kaffza-primary text-lg font-extrabold">Feature details</h2>
