  ...
  return (
    <main dir="ltr" className="mx-auto max-w-4xl px-6 py-12">
      <div className="flex items-center justify-between gap-3">
        <h1 className="text-kaffza-primary text-3xl font-extrabold">{getTrustTitle(item, true)}</h1>
        <Link className="text-kaffza-text/70 text-sm font-bold underline" href="/en/trust">
          Back to Trust & Safety
        </Link>
      </div>

      <p className="text-kaffza-text/80 mt-3 text-sm">{getTrustSummary(item, true)}</p>
