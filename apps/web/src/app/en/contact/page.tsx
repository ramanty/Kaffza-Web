  ...
  return (
    <main dir="ltr" className="mx-auto max-w-4xl px-6 py-12">
      <div className="flex items-center justify-between gap-3">
        <h1 className="text-primary text-3xl font-extrabold">Contact Us</h1>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        <Card className="p-6">
          <div className="text-primary text-lg font-extrabold">Technical Support</div>
        ...
        <Card className="p-6">
          <div className="text-primary text-lg font-extrabold">Sales & Subscriptions</div>
          <div className="text-foreground/80 mt-2 text-sm">
