  ...
  return (
    <div className="min-h-screen bg-[#05050f] text-white relative flex flex-col items-center selection:bg-blue-500/30">
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-32 pb-20 md:pt-48 flex flex-col md:flex-row items-center min-h-[90vh]">
        <div className="md:w-1/2 flex flex-col items-start text-left order-2 md:order-1">
          <motion.div {...fadeUpParams}>
            ...
            <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-lg leading-relaxed">
              Kaffza gives you everything you need to launch your store, manage disputes, and securely accept payments in minutes.
            </p>
      ...
      <section className="relative z-10 w-full bg-black/40 border-y border-white/5 backdrop-blur-xl py-32">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div className="text-center mb-16" {...fadeUpParams}>
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Unmatched Speed, Absolute Security</h2>
            <p className="text-slate-400 text-lg">Kaffza is built with cutting-edge tech to guarantee exceptional performance.</p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8 text-left">
            {[
              { icon: Zap, title: "Lightning Fast", desc: "Exceptional performance powered by advanced Edge Computing ensuring sub-second load times." },
              { icon: ShieldCheck, title: "Advanced Protection", desc: "Escrow system protecting both merchant and customer, backed by bank-grade encryption." },
              { icon: Globe2, title: "Global Expansion", desc: "Support multiple markets and global payment gateways with a single click." }
            ].map((Feature, i) => (
              <motion.div 
                key={i}
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-6 py-32">
        <motion.div className="text-center mb-20" {...fadeUpParams}>
          <h2 className="text-3xl md:text-5xl font-bold mb-4">How Kaffza Works?</h2>
          <p className="text-slate-400 text-lg">Three simple steps separate you from the world of e-commerce.</p>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-8 text-center relative">
          ...
          {[
            { step: "01", title: "Create Account", desc: "Sign up for free in seconds and customize your store." },
            { step: "02", title: "Add Products", desc: "Upload products, set prices, and connect payment gateways." },
            { step: "03", title: "Receive Orders", desc: "Launch! Start making sales and manage shipments easily." }
          ].map((item, i) => (
            <motion.div 
              key={i}
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div {...fadeUpParams}>
            <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight">
              Ready to make a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Leap</span> in your sales?
            </h2>
            <p className="text-xl text-slate-300 mb-10">
              Join thousands of merchants who chose Kaffza to grow their businesses safely and easily.
            </p>
            <Link
              href="/en/merchant/login"
