    ...
    <>
      ...
      <SafeAreaView style={styles.container} edges={['bottom']}>
        {items.length === 0 ? (
          ...
          <>
            <FlatList data={items} renderItem={renderItem} keyExtractor={(i) => String(i.product.id)} contentContainerStyle={styles.list} />
...
const styles = StyleSheet.create({
  ...
  list: { padding: 16 },
  itemRow: { backgroundColor: Colors.surface, borderRadius: 12, padding: 16, marginBottom: 12, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6, elevation: 2 },
  itemInfo: { flexDirection: 'row-reverse', justifyContent: 'space-between', marginBottom: 12 },
  itemName: { fontSize: 16, fontFamily: 'Tajawal_700Bold', color: Colors.text.primary, textAlign: 'right' },
  ...
  qtyText: { fontSize: 16, fontFamily: 'Tajawal_700Bold', color: Colors.text.primary, minWidth: 24, textAlign: 'center' },
  removeText: { fontSize: 13, fontFamily: 'Tajawal_500Medium', color: '#EF4444' },
  footer: { padding: 16, borderTopWidth: 1, borderTopColor: '#E5E7EB', backgroundColor: Colors.surface },
  ...
  checkoutBtn: { backgroundColor: Colors.primary, borderRadius: 12, padding: 16, alignItems: 'center', marginBottom: 8 },
